...
WebUI.click(findTestObject('Object Repository/Page_Checkout/radio_DirectBankTransfer'))

WebUI.click(findTestObject('Object Repository/Page_Checkout/btn_CheckoutPlaceOrder'))

WebUI.verifyElementVisible(findTestObject('Page_Checkout/text_ThankYou.YourOrderHasBeenReceived'))
